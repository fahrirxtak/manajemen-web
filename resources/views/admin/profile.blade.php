                    ...
                    <div class="mt-6">
                        ...
                        <ul>
                            <li class="flex items-center gap-1 mb-3">
                                <span
                                    class="w-[30%] text-base font-semibold text-neutral-600 dark:text-neutral-200">Full
                                    Name</span>
                            ...
                            <li class="flex items-center gap-1">
                                <span class="w-[30%] text-base font-semibold text-neutral-600 dark:text-neutral-200">
                                    Bio</span>
                                <span class="w-[70%] text-secondary-light font-medium">: Lorem Ipsum is simply dummy
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    ...
                    <ul class="tab-style-gradient flex flex-wrap text-sm font-medium text-center mb-5" id="default-tab"
                        ...
                        <li class="" role="presentation">
                            <button
                                ...
                                id="change-password-tab" data-tabs-target="#change-password" type="button"
                    ...
                    <div id="default-tab-content">
                        ...
                        <div class="hidden" id="change-password" role="tabpanel"
                        ...
                        <div class="hidden" id="notification-password" role="tabpanel"
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span
                                        class="form-check-label line-height-1 font-medium text-secondary-light">Company
                                        News</span>
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span
                                        class="form-check-label line-height-1 font-medium text-secondary-light">Weekly
                                        News Letters</span>
                                    <input class="form-check-input" type="checkbox" role="switch"
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span
                                        class="form-check-label line-height-1 font-medium text-secondary-light">Meetups
                                        Near you</span>
                            ...
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span
                                        class="form-check-label line-height-1 font-medium text-secondary-light">Orders
                                        Notifications</span>
                                    <input class="form-check-input" type="checkbox" role="switch"
