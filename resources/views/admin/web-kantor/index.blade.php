<x-admin-layout>
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        <h6 class="font-semibold mb-0 dark:text-white">Web Kantor</h6>
        <ul class="flex items-center gap-[6px]">
            ...
            <li class="font-medium dark:text-white">Web Kantor</li>
        </ul>
    </div>
                    ...
                    <table id="selection-table"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/user-list/user-list6.png') }}"
                                            alt="" class="shrink-0 me-3 rounded-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/user-list/user-list7.png') }}"
                                            alt="" class="shrink-0 me-3 rounded-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/user-list/user-list8.png') }}"
                                            alt="" class="shrink-0 me-3 rounded-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/user-list/user-list9.png') }}"
                                            alt="" class="shrink-0 me-3 rounded-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/user-list/user-list10.png') }}"
                                            alt="" class="shrink-0 me-3 rounded-lg">
