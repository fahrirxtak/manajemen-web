                            ...
                            <div class="mt-4">
                                    ...
                                    <div class="flex items-center gap-2 w-full">
                                        <div class="ms-auto">
                                            <div class="w-[66px] bg-gray-200 rounded-full h-2.5 dark:bg-gray-600">
                                                <div class="bg-orange-500 h-2.5 rounded-full" style="width: 80%">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="flex items-center justify-between gap-3 mb-3">
                                    ...
                                    <div class="flex items-center gap-2 w-full">
                                        <div class="ms-auto">
                                            <div class="w-[66px] bg-gray-200 rounded-full h-2.5 dark:bg-gray-600">
                                                <div class="bg-success-500 h-2.5 rounded-full" style="width: 80%">
                                                </div>
                                            </div>
                                        </div>
                                        <span class="text-secondary-light font-xs font-semibold">80%</span>
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <div class="flex items-center gap-2 w-full">
                                        <div class="ms-auto">
                                            <div class="w-[66px] bg-gray-200 rounded-full h-2.5 dark:bg-gray-600">
                                                <div class="bg-purple-600 h-2.5 rounded-full" style="width: 80%">
                                                </div>
                                            </div>
                                        </div>
                                        <span class="text-secondary-light font-xs font-semibold">80%</span>
                    ...
                    <div class="card h-full rounded-lg border-0 overflow-hidden">
                        <div class="card-body p-6">
                            ...
                            <div class="flex flex-wrap items-center mt-4">
                                ...
                                <div id="donutChart" class="grow apexcharts-tooltip-z-none title-style circle-none">
                                </div>
                            </div>
