                                ...
                                <li>
                                    <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4"
                                        ...
                                        <iconify-icon icon="mdi:shield-account-outline"
                                            class="icon text-xl"></iconify-icon> Admin Dashboard
                                    </a>
                                </li>
                            @endrole

                            {{-- Menu khusus Marketing --}}
                            @role('marketing')
                                <li>
                                    <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4"
                                        href="{{ route('marketing.dashboard') }}">
                                        <iconify-icon icon="mdi:chart-line" class="icon text-xl"></iconify-icon> Marketing
                                        Dashboard
                                    </a>
                                </li>
                            @endrole
                                ...
                                <li>
                                    <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4"
                                        ...
                                        <iconify-icon icon="mdi:account-multiple-outline"
                                            class="icon text-xl"></iconify-icon> Client Dashboard
                                    </a>
                                </li>
                            @endrole

                            {{-- Menu khusus Investor --}}
                            @role('investor')
                                <li>
                                    <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4"
                                        href="{{ route('investor.dashboard') }}">
                                        <iconify-icon icon="mdi:finance" class="icon text-xl"></iconify-icon> Investor
                                        Dashboard
                                    </a>
                                </li>
                            @endrole
