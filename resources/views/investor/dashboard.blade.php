<x-investor-layout>
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        ...
        <ul class="flex items-center gap-[6px]">
            ...
            <li class="font-medium dark:text-white">Investor</li>
        </ul>
    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm mb-0">
                                Increase by
                                <span
                                    class="bg-danger-100 dark:bg-danger-600/50 px-1 py-0.5 rounded-sm font-medium text-danger-600 dark:text-danger-400 text-sm">-200</span>
                                this week
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="relative h-[70px]">
                                ...
                                <span
                                    ...
                                    <iconify-icon icon="mdi:emoji"
                                        class="text-primary-600 text-base mb-0"></iconify-icon>
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center gap-2 w-full">
                                <div class="w-full max-w-66 ms-auto">
                                    <div class="progress progress-sm rounded-full" role="progressbar"
                                        ...
                                        aria-valuemax="100">
                                        <div class="progress-bar bg-primary-600 rounded-full" style="width: 80%;">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-2 w-full">
                                <div class="w-full max-w-66 ms-auto">
                                    <div class="progress progress-sm rounded-full" role="progressbar"
                                        aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                        aria-valuemax="100">
                                        <div class="progress-bar bg-warning-600 rounded-full" style="width: 49%;">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-2 w-full">
                                <div class="w-full max-w-66 ms-auto">
                                    <div class="progress progress-sm rounded-full" role="progressbar"
                                        aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                        aria-valuemax="100">
                                        <div class="progress-bar bg-success-600 rounded-full" style="width: 100%;">
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-span-12 lg:col-span-6 2xl:col-span-3">
            <div class="card h-full rounded-lg border-0">
                <div class="card-body p-6">
                    ...
                    <div class="relative">
                        <span
                            class="w-[80px] h-[80px] bg-white dark:bg-neutral-700 shadow-xl text-neutral-600 dark:text-neutral-200 font-bold text-2xl flex justify-center items-center rounded-full absolute end-0 top-0 z-1">20k</span>
                        <div id="statisticsDonutChart"
                            class="mt-9 grow apexcharts-tooltip-z-none title-style circle-none"></div>
                        <span
                            class="w-[80px] h-[80px] bg-white dark:bg-neutral-700 shadow-xl text-neutral-600 dark:text-neutral-200 font-bold text-2xl flex justify-center items-center rounded-full absolute start-0 bottom-0 z-1">50k</span>
                    </div>
                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/asset/asset-img1.png') }}"
                                                alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                            <div class="grow">
                                                <h6 class="text-base mb-0 font-normal">Gold</h6>
                                                <span class="text-sm text-secondary-light font-normal">Main
                                                    Asset</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 px-4 py-1.5 rounded-lg font-medium text-sm">Completed</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/asset/asset-img2.png') }}"
                                                alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                            <div class="grow">
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="bg-warning-100 dark:bg-warning-600/25 text-warning-600 dark:text-warning-400 px-4 py-1.5 rounded-lg font-medium text-sm">In
                                            Progress</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/asset/asset-img3.png') }}"
                                                alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/asset/asset-img4.png') }}"
                                                alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/asset/asset-img5.png') }}"
                                                alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                            <div class="grow">
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    ...
                    <div class="flex items-start gap-2 mb-5">
                        <img src="{{ asset('assets/images/notice/board-img1.png') }}" alt=""
                            class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
                            <h6 class="text-base mb-1 font-semibold">Admin</h6>
                            <p class="text-sm text-secondary-light font-medium mb-1">Lorem Ipsum is simply dummy text
                                of the printing and typesetting industry. Lorem Ipsum is simply dummy.</p>
                            <span class="text-sm text-secondary-light font-normal">25 Jan 2025</span>
                        </div>
                    </div>

                    <div class="flex items-start gap-2 mb-5">
                        <img src="{{ asset('assets/images/notice/board-img2.png') }}" alt=""
                            class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
                    ...
                    <div class="flex items-start gap-2">
                        <img src="{{ asset('assets/images/notice/board-img3.png') }}" alt=""
                            class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
                            <h6 class="text-base mb-1 font-semibold">Cameron Williamson</h6>
                            <p class="text-sm text-secondary-light font-medium mb-1">Lorem Ipsum is simply dummy text
                                of the printing Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry.</p>
                            <span class="text-sm text-secondary-light font-normal">25 Jan 2025</span>
                        </div>
                    </div>
                                        ...
                                        <div class="max-w-[44px]2 mx-auto">
                                            <div class="w-full">
                                                <div class="progress progress-sm rounded-full" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-red-600 rounded-full"
                                                        style="width: 30%;"></div>
                                                </div>
                                            </div>
