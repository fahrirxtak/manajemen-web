<x-client-layout>
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        ...
        <ul class="flex items-center gap-[6px]">
            ...
            <li class="font-medium dark:text-white">Client</li>
        </ul>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="col-span-12 md:col-span-4">
                            <div class="trail-bg h-full text-center flex flex-col justify-between items-center p-4 rounded-lg bg-cover bg-no-repeat bg-center"
                                style="background-image: url('{{ asset('assets/images/home-nine/trail-bg.png') }}');">
                                <h6 class="text-white text-xl">Upgrade Your Plan</h6>
                                <div class="">
                                    <p class="text-white mb-2">Your free trial expired in 7 days</p>
                                    <a href="#"
                                        class="btn py-2 rounded-[50rem] w-full bg-gradient-to-r from-[#CBFFF9] to-[#FFEEB1] text-sm justify-center dark:text-neutral-900 hover:scale-[1.06]">Upgrade
                                        Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-8">
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div
                                        class="rounded-lg h-full text-center p-5 bg-success-100 dark:bg-success-600/10">
                                        <span
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap gap-2 justify-between">
                        ...
                        <select
                            class="form-select form-select-sm w-auto bg-base border text-neutral-600 dark:text-white dark:bg-neutral-800">
                    ...
                    <div class="mt-8 flex flex-wrap gap-6 items-center justify-between">
                        <div class="flex flex-col gap-6">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-primary-100 dark:bg-primary-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/ticket1.png') }}" alt=""
                                        class="">
                                </div>
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-100 dark:bg-warning-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/ticket2.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-bold">172</h6>
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-100 dark:bg-purple-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/ticket3.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-bold">172</h6>
                        ...
                        <div class="relative">
                            ...
                            <div
                                class="text-center max-w-[135px] max-h-[135px] bg-warning-focus rounded-[50%] p-4 aspect-ratio-1 flex flex-col justify-center items-center absolute start-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 aspect-[1] rtl:translate-x-1/2">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="mt-8">
                        <div class="flex items-center justify-between gap-4 mb-6">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-success-200 dark:bg-success-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/payment1.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4 mb-6">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-info-200 dark:bg-info-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/payment2.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4 mb-6">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-200 dark:bg-warning-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/payment3.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4 mb-0">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-200 dark:bg-purple-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/payment4.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        <div class="col-span-12 lg:col-span-6">
                            <div id="world-map"
                                class="border border-neutral-300 dark:border-neutral-300/20 rounded-lg bg-neutral-50 dark:bg-neutral-600/20 h-full">
                            </div>
                        </div>

                        <div class="col-span-12 lg:col-span-6">
                            <div
                                class="h-full border border-neutral-300 dark:border-neutral-300/20 p-4 pe-0 rounded-lg">
                                    ...
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="{{ asset('assets/images/flags/flag1.png') }}" alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="w-full max-w-66 ms-auto">
                                                <div class="progress progress-sm rounded-[50rem]" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-primary-600 rounded-[50rem]"
                                                        style="width: 80%;"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="w-full max-w-66 ms-auto">
                                                <div class="progress progress-sm rounded-[50rem]" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-orange rounded-[50rem]"
                                                        style="width: 60%;"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="w-full max-w-66 ms-auto">
                                                <div class="progress progress-sm rounded-[50rem]" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-yellow rounded-[50rem]"
                                                        style="width: 49%;"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="w-full max-w-66 ms-auto">
                                                <div class="progress progress-sm rounded-[50rem]" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-success-main rounded-[50rem]"
                                                        style="width: 100%;"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="w-full max-w-66 ms-auto">
                                                <div class="progress progress-sm rounded-[50rem]" role="progressbar"
                                                    aria-label="Success example" aria-valuenow="25" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <div class="progress-bar bg-info-main rounded-[50rem]"
                                                        style="width: 30%;"></div>
                                                </div>
                                            </div>
                    ...
                    <div class="relative h-full min-h-[320px]">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-4 min-h-[inherit]">
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
                                <div class="flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#ffba4540] to-[#f4743540]"
                                    style="min-height: 50%;">
                                    <span
                                        class="w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-warning-600 rounded-[50%] mb-3">
                                        <img src="{{ asset('assets/images/home-nine/source-icon1.png') }}"
                                            alt="">
                                    </span>
                            ...
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
                                <div class="flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#fc788a40] to-[#98168b40]"
                                    style="min-height: 66%;">
                                    <span
                                        class="w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-purple-600 rounded-[50%] mb-3">
                                        <img src="{{ asset('assets/images/home-nine/source-icon2.png') }}"
                                            alt="">
                                    </span>
                            ...
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
                                <div class="flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#19cfef40] to-[#0d6ab840]"
                                    style="min-height: 82%;">
                                    <span
                                        class="w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-primary-600 rounded-[50%] mb-3">
                                        <img src="{{ asset('assets/images/home-nine/source-icon3.png') }}"
                                            alt="">
                                    </span>
                            ...
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
                                <div class="flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#86dd6640] to-[#028c4b40]"
                                    style="min-height: 96%;">
                                    <span
                                        class="w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-success-600 rounded-[50%] mb-3">
                                        <img src="{{ asset('assets/images/home-nine/source-icon4.png') }}"
                                            alt="">
                                    </span>
                    ...
                    <div class="flex flex-col gap-[22px] mt-8">
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-100 dark:bg-purple-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/socials1.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-100 dark:bg-warning-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/socials2.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-info-100 dark:bg-info-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/socials3.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-success-100 dark:bg-success-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/socials4.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-danger-100 dark:bg-danger-600/20 shrink-0">
                                    <img src="{{ asset('assets/images/home-nine/socials5.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <table class="table bordered-table mb-0 rounded-0 border-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/user-grid/user-grid-img1.png') }}"
                                                alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                                <h6 class="text-base mb-0">Kristin Watson</h6>
                                                <span
                                                    class="text-sm text-neutral-600 font-medium">ulfaha@mail.ru</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>#63254</td>
                                    ...
                                    <td>$12,408.12</td>
                                    <td> <span
                                            class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Member</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/user-grid/user-grid-img2.png') }}"
                                                alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                                <h6 class="text-base mb-0">Theresa Webb</h6>
                                                <span
                                                    class="text-sm text-neutral-600 font-medium">joie@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>#63254</td>
                                    ...
                                    <td>$12,408.12</td>
                                    <td> <span
                                            class="bg-purple-100 dark:bg-purple-600/20 text-purple-600 dark:text-purple-600 px-2.5 py-1 rounded-lg font-medium text-sm">New
                                            Customer</span> </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/user-grid/user-grid-img3.png') }}"
                                                alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                    ...
                                    <td>$12,408.12</td>
                                    <td> <span
                                            class="bg-warning-focus text-warning-main dark:text-warning-main px-2.5 py-1 rounded-lg font-medium text-sm">Signed
                                            Up </span> </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/user-grid/user-grid-img4.png') }}"
                                                alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                                <h6 class="text-base mb-0">Robert Fox</h6>
                                                <span
                                                    class="text-sm text-neutral-600 font-medium">fellora@mail.ru</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>#63254</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="{{ asset('assets/images/user-grid/user-grid-img5.png') }}"
                                                alt=""
                                                class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
